...
public class SessionManager {
    ...
    public void setUserInfo(TUser user) {
        ...
        editor.putString(AppConstants.PROFILE_PICTURE, user.getProfile());//TODO Usuario con imagen de perfil??
    ...
    public String getProfile() { return prefs.getString(AppConstants.PROFILE_PICTURE, ""); }

    public TUser getSesionUser(){
        return new TUser(getUsername(), getPassword(), getFirstName(),
                getSurname(), getEmail(), getGender(),
                getBirthDate(), getCity(), getRol(), getProfile());
    }
}
